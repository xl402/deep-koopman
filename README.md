...
|-----------|------------------------------------------------------------------|--------------------|--------------------------------------|
| **LREN**  | **L**inearly **R**ecurrent **E**ncoder **N**etwork               |                    | <img src="https://i.imgur.com/zk0sbWV.png" width="200"> |
| **DENIS** | **D**eep **E**ncoder with **I**nitial **S**tate Parameterisation |                    | <img src="https://i.imgur.com/dTgpnbo.png" width="200"> |
| **DEINA** | **D**eep **E**ncoder for **I**nput **N**on-**A**ffine systems    |                    | <img src="https://i.imgur.com/4lvGkWC.png" width="200"> |
